...
# NOTE: storage_configuration_id is REQUIRED for workspace DBFS root
# This is separate from Unity Catalog metastore - you need BOTH:
#   - storage_configuration_id = DBFS root (workspace files, libraries, logs)
#   - Unity Catalog metastore = Data governance layer (your tables/data)
